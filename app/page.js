...
import { INDUSTRIES, SITE, EXPERTISE_GROUPS, EXPERIENCE } from "@/lib/site";
...
<Hero />
      ...
      <section className="section" id="ai-home">
        <div className="section__inner">
          ...
          <Link className="btn btn--primary" href="/ai-automation">
      ...
      <section className="section" id="industries-home">
        <div className="section__inner">
          ...
          <div className="chip-grid chip-grid--wide">
            {INDUSTRIES.map((item) => (
              <Link className="chip chip--outline" key={item.name} href="/industries">
                {item.name}
              </Link>
            ))}
          </div>
      ...
      <section className="section section--alt" id="tech-home">
        <div className="section__inner">
          ...
          <Link className="btn btn--ghost" href="/expertise">
            View Expertise
          </Link>
        </div>
      </section>
