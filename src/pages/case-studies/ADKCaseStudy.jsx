...
import { ADK_AGENTS, ADK_INPUTS, ADK_OUTPUTS } from "../../data/site";

export default function ADKCaseStudy() {
  return (
    <>
      <Seo
        title="Google ADK Agent Orchestration Case Study | Tushant Rajpal"
        description="Modernizing conversational AI from linear Dialogflow flows to specialized Google ADK agents with sequential, parallel and graph orchestration."
