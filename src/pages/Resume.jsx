...
import { EXPERTISE_GROUPS, EXPERIENCE, SITE } from "../data/site";

export default function Resume() {
  return (
    <>
      <Seo
        title="Resume | Tushant Rajpal — Senior Full Stack Engineer"
        description="Browser-friendly resume for Tushant Rajpal covering summary, skills, experience and achievements, with PDF download."
        path="/resume"
      />
      <PageHero
        eyebrow="Resume"
