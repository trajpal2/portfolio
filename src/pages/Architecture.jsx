...
export default function Architecture() {
  return (
    <>
      <Seo
        title="Architecture & Engineering | Tushant Rajpal"
        description="Enterprise architecture, AI architecture and event-driven architecture patterns for scalable software systems."
        path="/architecture"
      />
      <PageHero
