...
export default function Footer() {
  return (
    <footer className="footer">
      <div className="footer__inner footer__inner--wide">
        <div className="footer__brand-block">
          <p className="footer__brand">{SITE.name}</p>
          <p className="footer__tag">{SITE.title}</p>
        </div>
        ...
        <div className="footer__legal" aria-label="Legal">
        ...
        <p className="footer__copy">
          &copy; {new Date().getFullYear()} {SITE.name}. Senior Full Stack Engineer / Full Stack Architect.
        </p>
      </div>
    </footer>
  );
